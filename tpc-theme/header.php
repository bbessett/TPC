...
<!--[if gt IE 9]><!--><html <?php language_attributes(); ?> class="no-js"><!--<![endif]-->
	...
	<head>
		...
		<script type="text/javascript" src="/wp-content/themes/tpc/js/respond.min.js"></script>
	</head>
	...
	<div class="container">
			...
			<div class="search-wrap">
				...
				<a href="/contact-us/" class="h-links right list-heading bold">Contact Us</a>
					...
					<a class='my-login-mobile just-visible-phone' target=_blank href="https://mychart.tpcllp.com/MyChart/" rel="nofollow"><span class="ml">My Login</span></a>
					<a target="_blank" title="Follow The Portland Clinic on Youtube" href="https://www.youtube.com/channel/UC-bnJcE16ETCZlGojSduT1w"><span class="yt yt-play"></span></a>
