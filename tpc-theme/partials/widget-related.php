...
<?php if( $related ) :  ?>
 <div class="grid-block related">
	...
	<?php // print_r('$category->slug')?>
 <h5 class="post-title"><a href="<?php echo site_url(); ?>/<?php echo $category->slug; ?>">More <?php echo $category->name; ?> Specialists </a></h5>
    ...
    <li>
      <div class="meta">
        <div class="meta-title">
       		<p class="list-heading"><a href="<?php the_permalink() ?>" rel="bookmark" title="<?php the_title(); ?>">
       		<?php the_title(); ?></a></p>
			...
			<?php if( $relationships ): ?>
		      <div class="meta-location">
				<?php foreach( $relationships as $p): ?>
					...
					<p class="small">
					<a style="color:#666!important;"  href="<?php echo get_the_permalink( $p->ID ); ?>"><?php echo get_the_title( $p->ID ); ?></a></p>
